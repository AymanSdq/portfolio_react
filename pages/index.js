...
export default function Home() {
  const [darkMode, settDarkMode] = useState(false);
  return (
      ...
      <main className='bg-white px-10 md:px-20 lg:px-40 dark:bg-gray-900 dark:text-white'>
        <section className='min-h-screen '>
          <nav className='py-10 mb-12 flex justify-between'>
            ...
            <ul className='flex items-center'>
              <li>
                <BsFillMoonStarsFill onClick={()=> settDarkMode(!darkMode)} className='cursor-pointer text-2xl
                '/>
              </li>
              <li>
          ...
          <div className='text-center p-10'>
            ...
            <h2 className='text-5xl py-2 text-teal-600 font-medium md:text-6xl'>Ayman Sedqi</h2>
        ...
        <section>
          <div className='dark:text-white'>
            ...
            <p className='text-md py-2 leading-8 text-gray-80'>Since the beginning of my journey as a freelance designer and
          ...
          <div className='lg:flex g-20'>
            ...
            <div className='shadow-lg text-center p-10 rounded-xl my-10 flex flex-col items-center'>
